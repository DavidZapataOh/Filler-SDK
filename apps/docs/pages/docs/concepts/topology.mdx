...
See [`packages/jit-hints/deploy/`](https://github.com/filler-sdk/filler-sdk/tree/main/packages/jit-hints/deploy) for Railway + Fly + Docker Compose deploy manifests.

## Read the code

- Architecture overview: [README.md](https://github.com/filler-sdk/filler-sdk#readme)
- Indexer deploy options: [`packages/jit-hints/deploy/RUNBOOK.md`](https://github.com/filler-sdk/filler-sdk/blob/main/packages/jit-hints/deploy/RUNBOOK.md)
- Hero example deploy: [`examples/treasury-rebalance/.env`](https://github.com/filler-sdk/filler-sdk/blob/main/examples/treasury-rebalance/.env)
