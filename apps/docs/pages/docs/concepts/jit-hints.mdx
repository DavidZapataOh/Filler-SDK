...
Every step is open-source ([packages/jit-hints/](https://github.com/DavidZapataOh/filler-sdk/tree/main/packages/jit-hints)) and self-hostable.
...
The TickMath BigInt port that powers steps 1–3 is in [`packages/jit-hints/src/tickMath.ts`](https://github.com/DavidZapataOh/filler-sdk/tree/main/packages/jit-hints/src) — kept in sync with the Solidity `TickMath.sol` from v4-core.
...
The `tickCalibration.ts` layer in the SDK refines indexer hints into v4-safe ticks (snaps to `tickSpacing`, applies safety margins, caps liquidity multipliers). See [`packages/sdk/src/fills/tickCalibration.ts`](https://github.com/DavidZapataOh/filler-sdk/blob/main/packages/sdk/src/fills/tickCalibration.ts).
...
- Indexer source: [`packages/jit-hints/`](https://github.com/DavidZapataOh/filler-sdk/tree/main/packages/jit-hints)
- TickMath port: [`packages/jit-hints/src/tickMath.ts`](https://github.com/DavidZapataOh/filler-sdk/blob/main/packages/jit-hints/src/tickMath.ts)
- SDK consumption: [`packages/sdk/src/fills/tickCalibration.ts`](https://github.com/DavidZapataOh/filler-sdk/blob/main/packages/sdk/src/fills/tickCalibration.ts)
