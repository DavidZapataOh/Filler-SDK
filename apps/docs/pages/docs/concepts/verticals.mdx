...
**Hero example shipped**: [`examples/treasury-rebalance`](https://github.com/DavidZapataOh/filler-sdk/tree/main/examples/treasury-rebalance) — workspace-linked, runs against an anvil mainnet fork via `bun run e2e:fork`.
...
- All four templates: [`packages/cli/templates/`](https://github.com/DavidZapataOh/filler-sdk/tree/main/packages/cli/templates)
- Hero example (workspace-linked): [`examples/treasury-rebalance/`](https://github.com/DavidZapataOh/filler-sdk/tree/main/examples/treasury-rebalance)
