...
The hero recipe is materialised at [`examples/treasury-rebalance`](https://github.com/DavidZapataOh/filler-sdk/tree/main/examples/treasury-rebalance) — workspace-linked, ready to run against an anvil mainnet fork:
